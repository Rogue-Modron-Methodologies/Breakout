...
//                
//                
//                ball.setPosition(window.getSize().x / 2 - ball.getRadius(),
...
//void handleBallVelocity() {
//    if (movD) {
//        if (ball.getVelocity().y < ball.getPosMaxAcc())
//            ball.setVelocityY(ball.getVelocity().y + ball.getAcceleration());
//        else
//            ball.setVelocityY(ball.getPosMaxAcc());
//    }
//    else if (movU) {
//        if (ball.getVelocity().y > ball.getNegMaxAcc())
//            ball.setVelocityY(ball.getVelocity().y - ball.getAcceleration());
//        else
//            ball.setVelocityY(ball.getNegMaxAcc());
//    }
//    else if (movR) {
//        if (ball.getVelocity().x < ball.getPosMaxAcc())
//            ball.setVelocityX(ball.getVelocity().x + ball.getAcceleration());
//        else
//            ball.setVelocityX(ball.getPosMaxAcc());
//    }
//    else if (movL) {
//        if (ball.getVelocity().x > ball.getNegMaxAcc())
//            ball.setVelocityX(ball.getVelocity().x - ball.getAcceleration());
//        else
//            ball.setVelocityX(ball.getNegMaxAcc());
//    }
//    
//}
//
